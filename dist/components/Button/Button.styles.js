...
var roundStyle = function roundStyle(props) {
  if (props.round) {
    switch (props.size) {
      ...
      case 'large':
        return (0, _styledComponents.css)(_templateObject19, _index.fontSize.giga, _index.tabletMaxWidth);
      case 'x-large':
        return (0, _styledComponents.css)(_templateObject20, _index.fontSize.tera, _index.tabletMaxWidth);
      default:
        break;
    }
